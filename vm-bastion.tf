resource "google_compute_instance" "bastion" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "sudo curl https://storage.googleapis.com/kubernetes-release/release/v1.15.3/bin/linux/amd64/kubectl -o /usr/local/bin/kubectl",
      "curl https://storage.googleapis.com/kubernetes-release/release/v1.15.3/bin/linux/amd64/kube-controller-manager -o kube-controller-manager",
      "curl https://storage.googleapis.com/kubernetes-release/release/v1.15.3/bin/linux/amd64/kube-scheduler -o kube-scheduler",
      "curl https://storage.googleapis.com/kubernetes-release/release/v1.15.3/bin/linux/amd64/kube-apiserver -o kube-apiserver",
